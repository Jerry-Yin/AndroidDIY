 ...
 */
public class AdapterWrapper extends CusRecyclerViewAdapter {
    ...
    private CusRecyclerViewAdapter mAdapter;
    ...
    public AdapterWrapper(CusRecyclerViewAdapter adapter) {
        super(adapter.getMC(), adapter.getMDataList());
        mAdapter = adapter;
    }

    public AdapterWrapper(@NotNull Context mC, @NotNull ArrayList<News> mDataList) {
        super(mC, mDataList);
    }

    class WrapperHolder extends CusViewHolder {
        ...
        WrapperHolder(View itemView) {
            super(itemView);
            mTvLoad = itemView.findViewById(R.id.tv_load_more);
            mPbLoad = itemView.findViewById(R.id.progressBar_load);
        }
    ...
    @Override
    public void onBindViewHolder(CusRecyclerViewAdapter.CusViewHolder holder, int position) {
